...
# НЕ ЗРОБИВ!
#-При передачі невірних даних викликати помилку TypeError            (вона ітак викликається)
#-Обробити !виняткові! ситуації та повідомити про них користувача    (які це виняткові?)
#-Виклик функції: my_sort(lambda x: len(x), [‘Aa’, ‘cCc’, ‘bbbbb’, ‘a’]) (хз як зробити щоб приймало lambda спочатку)
